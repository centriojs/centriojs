...
class UserRouter {
    ...
    setUserRoutes(router) {
        ...
        router.post( '/user-settings', this.updateSettings.bind(this) );
    }
    ...
    setUserAdminRoutes(router) {
        router.setView( '/users', this.getUsers.bind(this) );
        router.setView( '/users/page/:page', this.getUsers.bind(this) );
        router.setView( '/users/edit', this.editUser.bind(this) );
        router.setView( '/users/edit/:id', this.editUser.bind(this) );
        router.setView( '/user-group', this.getGroups.bind(this) );
        router.setView( '/user-group/:id', this.editGroup.bind(this) );

        router.post( '/users/edit', this.updateUser.bind(this) );
        router.post( '/users/edit/:id', this.updateUser.bind(this) );
        router.get( '/users/delete/:id', this.deleteUser.bind(this) );
        router.post( '/user-group/:id', this.updateGroup.bind(this) );
        router.get( '/user-group/delete/:id', this.deleteGroup.bind(this) );

        router.setView( '/profile', this.editProfile.bind(this) );
        router.setView( '/profile/:id', this.editProfile.bind(this) );
    }
