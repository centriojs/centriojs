...
class PresetRoutes {
    ...
    setAdminRoutes(router) {
        router.setView( '/presets', this.getPresets.bind(this) );
        router.setView( '/presets/page/:page', this.getPresets.bind(this) );
        router.setView( '/presets/:type', this.getPresets.bind(this) );
        router.setView( '/presets/:type/page/:page', this.getPresets.bind(this) );

        router.setView( '/presets/edit', this.editPreset.bind(this) );
        router.setView( '/presets/edit/:id', this.editPreset.bind(this) );
        router.post( '/presets/edit', this.updatePreset.bind(this) );
        router.post( '/presets/edit/:id', this.updatePreset.bind(this) );
        router.post( '/presets/delete/:id', this.deletePreset.bind(this) );
    }
