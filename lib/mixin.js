...
_.mixin({
    ...
    stripSlashes: str => {
        if ( ! str || 'undefined' === typeof str || _.isBoolean(str) || 'number' === typeof str ) {
            return str;
        }
    ...
    duration: () => {
        return {
            dayInMilSeconds: 86400 * 6000,
            hourInMilSeconds: 3600 * 6000,
            minInMilSeconds: 60 * 6000
        };
    }
});
module.exports = _;