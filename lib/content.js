 ...
 * @returns {Promise<*>}
 */
const deleteContentProperty = async (typeId, contentId, name, value) => {
    typeId = parseInt(typeId);
...
/**
 * Remove category from the database base on the given column and value.
 *
 * @param {int} typeId
 * @param {string} column
 * @param {string|int|array} value
...
const setContentCategory = (typeId, contentId, catId) => {

};

const deleteContentCategory = (typeId, contentId, catId) => {
